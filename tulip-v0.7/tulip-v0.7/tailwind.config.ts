  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        tulip: {
          DEFAULT: "hsl(var(--tulip))",
          light: "hsl(var(--tulip-light))",
          dark: "hsl(var(--tulip-dark))",
        },
        blush: {
      ...
      animation: {
        ...
        "blob-pulse-alt": "blob-pulse-alt 10s ease-in-out infinite",
        "blob-pulse-slow": "blob-pulse 12s ease-in-out infinite",
